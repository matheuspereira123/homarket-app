...
$(document).ready(function() {
    ...
    <div class="row text-center">
        <div class="col-12 text-center">
            <img src="recursos/img/preloader.gif" class="img-loader">
        </div>
    </div>
</div>
    `
...
$('#produtos').click(function() {
    ...
    <p><img src="recursos/img/Leite.jpg" height="280" width="250"></p>
    ...
    <hr>
    <p><img class="offset-1" src="recursos/img/leite_condensado.png" width="150" height="120"></p>
    <h5 class="text-danger">Leite Condensado</h5>
    <p> R$5,00</p>
    <a href="#" class="btn btn-outline-success text-center"><i class="mdi mdi-cart-plus mdi-24px "></i></a>
    <a href="#" class="btn btn-outline-info text-center"><i class="mdi mdi-information-outline mdi-24px "></i></a>
    <hr>
    <p><img src="recursos/img/veja.jpg" width="200" height="180"></p>
